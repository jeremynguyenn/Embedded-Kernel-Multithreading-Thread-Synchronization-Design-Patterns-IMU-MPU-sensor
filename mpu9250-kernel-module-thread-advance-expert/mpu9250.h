...
struct mpu9250_thread_pool {
    ...
    void (*data_ready_cb)(struct mpu9250_data *);
    struct raw_notifier_head notifier;
    struct completion barrier_comp;
    wait_queue_head_t pause_wq;
    struct barrier thread_barrier;
};
...
struct mpu9250_data {
    ...
    struct raw_notifier_head notifier;
    struct recursive_mutex recursive_lock;
    struct completion event_pair;
    struct rwlock_t monitor_rwlock;
    wait_queue_head_t monitor_wq;
    bool lock_ordered;
    void (*cleanup_handler)(struct mpu9250_data *);
    atomic_t hold_count;
    atomic_t wait_count;
    struct semaphore philos_sem[5];
    struct mpu9250_timer *timer;
    struct custom_rwlock custom_rwlock;
    struct weak_semaphore weak_sem;
};
